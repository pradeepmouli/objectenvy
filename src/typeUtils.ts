import type { CamelCasedPropertiesDeep, ScreamingSnakeCase, Simplify } from 'type-fest';
...
type FlattenToEnv<T, Prefix extends string = ''> = T extends object
  ? {
      [K in keyof T & string]: T[K] extends object
        ...
        : Record<`${Prefix}${Prefix extends '' ? '' : '_'}${ScreamingSnakeCase<K>}`, string>;
    }[keyof T & string]
  : never;
 ...
 */
export type FromEnv<T> = CamelCasedPropertiesDeep<T>;
